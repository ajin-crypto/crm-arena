...
seed_database.py
────────────────
Populates the CRM Arena SQLite database with realistic mock data that
mirrors the frontend mock arrays in Phase 3.

Usage:
    cd backend
    python ../tools/seed_database.py

Runs safely multiple times — clears existing rows before inserting.
"""
